...
//
//case class SchedulerException(string: String) extends RuntimeException
///**
...
//  extends Closeable with ScheduledExecutorService{
//
...
//  val ShutdownTimeout = 3.seconds//config.getMillisDuration("akka.scheduler.shutdown-timeout")
//
...
//  }
//
//  val maxFrequency: Double = 1.second / TickDuration
//
//  /*
...
//      }
//
//    final def executeTask(): Boolean = extractTask(ExecutedTask) match {
